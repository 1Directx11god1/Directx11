...
void Engine::Update()
{
	...
	{
		jkl = true;
		this->gfx.mlop[this->gfx.q]->x = -0.9f;
		this->gfx.r(this->gfx.q);
	...
	else
	{
		if (jkl)
		{
			this->gfx.mlop[this->gfx.q]->x = 0.0f;
			this->gfx.mlop[this->gfx.q]->z = 0.0f;
			this->gfx.r(this->gfx.q);
		}
	}
	...
	{
		jkl = true;
		this->gfx.mlop[this->gfx.q]->y = 3.9f;
		this->gfx.r(this->gfx.q);
		//this->gfx.y(this->gfx.q);
		//this->gfx.y();
		//this->gfx.rizemove(true, this->gfx.q, true);
	...
	else
	{
		if (jkl)
		{
			this->gfx.mlop[this->gfx.q]->y = 0.0f;
			this->gfx.r(this->gfx.q);
		}
	}
